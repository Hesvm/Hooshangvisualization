...
export const TIMING = {
  tapFeedback: 130,
  suggestionCollapse: 180,
  chipToMessage: 220,
  settleScroll: 280,

  introAfterThinking: 280,
  q1AfterIntro: 450,
  ...
  betweenQuestions: 210,

  shortlistAfterSearch: 280,

  reasoningAfterThinking: 280,

  loanIntroAfterThinking: 280,
  preferenceAfterIntro: 350,

  offersAfterIntro: 280,

  validationIntroAfterThinking: 350,

  invoiceAfterThinking: 350,

  orderAfterThinking: 280,

  addressAfterThinking: 280,

  deliveryAfterThinking: 280,
} as const;
...
export const LOAN_INVOICE_HEADER_TITLE = "سبد خرید";
export const LOAN_INVOICE_TODAY_LABEL = "پرداخت امروز";
export const LOAN_INVOICE_DETAILS_TOGGLE = "نمایش جزئیات بیشتر";
export const LOAN_INVOICE_SECURITY_NOTE =
  "با تایید پرداخت، سفارش در دیجی‌کالا ثبت می‌شود و شرایط اقساط از طریق دیجی‌پی فعال می‌شود.";
export const LOAN_INVOICE_CTA = "تایید و پرداخت";

export function buildLoanInvoiceRemainderNote(months: number): string {
  return `باقی مبلغ با وام ${faNum(months)} ماهه پرداخت می‌شود`;
}
...
export const ORDER_SUMMARY_DELIVERY_ETA = "تحویل ظرف ۱ تا ۳ روز کاری";
