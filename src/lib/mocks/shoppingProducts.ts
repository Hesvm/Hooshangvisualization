...
export const laptopShortlist: ShoppingProduct[] = [
  ...
  },
  {
    ...
    affordability: {
      verdict: "با توجه به بودجه و روند قیمتی، خرید الان منطقیه",
      reasons: [
        "این مدل داخل محدوده بودجه‌ایه که گفتی و نسبت به مک‌بوک M4 حدود ۱۹ میلیون تومان کمتر هزینه می‌بره؛ یعنی از پس‌اندازت کمتر خرج می‌شه.",
        "قیمت لپ‌تاپ‌های وارداتی معمولاً همراه با نرخ دلار بالا می‌ره. اگه الان نخری، با ادامه روند فعلی بازار، تا ۶ ماه دیگه احتمالاً باید بیشتر پرداخت کنی.",
      ],
      forecast: [
        { label: "الان", price: 49 },
        { label: "۶ ماه دیگه", price: 58 },
      ],
    },
